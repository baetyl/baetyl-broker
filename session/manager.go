...
var (
	...
	ErrSessionMaxMessagePayloadExceeds          = errors.New("message payload exceeds the max limit")
	...
	ErrSessionMaxWillMessagePayloadExceeds      = errors.New("will message payload exceeds the max limit")
