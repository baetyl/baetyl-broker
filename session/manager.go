...
var (
	...
	ErrSessionCertificateCommonNameNotFound     = errors.New("certificate commonName not found")
	ErrSessionCertificateCommonNameNotPermitted = errors.New("certificate commonName not permitted")
