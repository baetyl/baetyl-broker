...
var (
	...
	ErrSessionPublishTopicInvalid               = errors.New("publish topic is invalid")
	ErrSessionPublishTopicNotPermitted          = errors.New("publish topic is not permitted")
	ErrSessionSubscribeTopicInvalid             = errors.New("subscribe topic is invalid")
	ErrSessionSubscribeTopicNotPermitted        = errors.New("subscribe topic is not permitted")
