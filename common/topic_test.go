...
func TestCheckTopic(t *testing.T) {
	tests := []struct {
		...
		{name: "6", topic: "$SYS/services/a", wildcard: true, want: true},
		{name: "7", topic: "a/b/c/d/e/f/g/h/i", wildcard: true, want: true},
		{name: "8", topic: "$baidu/a/b/c/d/e/f/g/h/i", wildcard: true, want: true},
		...
		{name: "13", topic: "$SYS", wildcard: false, want: false},
		...
		{name: "47", topic: "$SYS/+", wildcard: true, want: true},
		{name: "48", topic: "$SYS/#", wildcard: true, want: true},
		{name: "49", topic: "$SYS/services/a", wildcard: true, want: true},
		{name: "50", topic: "a/b/c/d/e/f/g/h/i", wildcard: true, want: true},
		{name: "51", topic: "$baidu/a/b/c/d/e/f/g/h/i", wildcard: true, want: true},

		{name: "52", topic: "", wildcard: true, want: false},
		{name: "53", topic: "++", wildcard: true, want: false},
		{name: "54", topic: "##", wildcard: true, want: false},
		{name: "55", topic: "#/+", wildcard: true, want: false},
		{name: "56", topic: "#/#", wildcard: true, want: false},
		{name: "57", topic: "$baidu", wildcard: false, want: false},
		{name: "58", topic: "$link", wildcard: false, want: false},
		{name: "59", topic: "$SYS", wildcard: false, want: false},
